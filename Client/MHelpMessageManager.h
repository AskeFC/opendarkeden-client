...
public:
	...
	void			removeSender(int senderIndex)		{ m_SenderVector.erase(m_SenderVector.cbegin() + senderIndex); }
	...
	void				removeMessage(int messageIndex)		{ m_MessageVector.erase(m_MessageVector.cbegin() + messageIndex); }
